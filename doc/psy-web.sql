...
INSERT INTO `post` VALUES ('3', '20', '123123', '0', null, null, '<p>123123123123123</p>', '0', '1', '2013-12-13 15:30:45', '2013-12-16 17:17:33');
...
CREATE TABLE `post_tag` (
  ...
  KEY `tag_post` (`tag_id`) USING BTREE,
  KEY `post_tag` (`post_id`) USING BTREE,
  CONSTRAINT `post_post` FOREIGN KEY (`post_id`) REFERENCES `post` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `tag_tag` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
